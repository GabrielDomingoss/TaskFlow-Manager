...
Crie o arquivo .env com suas credenciais locais do PostgreSQL:
...
Estes comandos criarão as tabelas, aplicarão as migrations e irão popular o banco com os dados iniciais para testes
